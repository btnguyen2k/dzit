...
class Quack_Util_IdUtils {
    ...
    const MASK_TIMESTAMP_48 = 0xFFFFFFFF; // 32 bits
    const MASK_NODE_ID_48 = 0x7; // 3 bits
    const MASK_SEQUENCE_48 = 0x1FFF; // 13 bits
    const SHIFT_TIMESTAMP_48 = 16;
    const SHIFT_NODE_ID_48 = 13;
    ...
    /**
     * Generates a 48-bit id as a binary string.
     *
     * @param string $nodeId
     * @param int $padding
     */
    public static function id48bin($nodeId = 1, $padding = 0) {
        list($usec, $sec) = explode(" ", microtime());
        $usec = $usec * 1000000;

        $sequence = (int)($usec) & self::MASK_SEQUENCE_48;
        $nodeId = $nodeId & self::MASK_NODE_ID_48;
        $timestamp = ($sec - self::TIMESTAMP_EPOCH) & self::MASK_TIMESTAMP_48;
    ...
    /**
     * Generates a 48-bit id as a hexadeximal string.
     *
     * @param string $nodeId
     * @param int $padding
     */
    public static function id48hex($nodeId = 1, $padding = 0) {
        $resultBin = self::id48bin($nodeId, 48);
